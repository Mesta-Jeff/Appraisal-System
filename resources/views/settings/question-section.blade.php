            ...
            <div class="modal-body">
                ...
                <form class="px-3" id="my-form">
                    ...
                    <div class="form-floating mb-2">
                        <textarea class="form-control" placeholder="What is the section about...?" name="section"  id="section" style="height: 100px">
                        </textarea>
                        <label for="descriptions">What is the section about...?</label>
                    </div>
        ...
        dataTable = $("#example").DataTable(
        {
            ...
            columns: [
                ...
                },
                {
                    data: null,
                    render: function(data, type, row) {
                        return '<button class="btn btn-primary btn-sm edit-btn mx-2" data-id="' + data.id + '" data-section="' + data.section + '" data-title="' + data.title + '"><i class="fas fa-edit mx-1"></i>Edit</button>' +
                        '<button class="btn btn-danger btn-sm delete-btn" data-id="' + data.id + '" data-title="' + data.title + '"><i class="fas fa-trash mx-1"></i>Remove</button>';
                    }
                }
