        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="px-3" id="my-form">
                    ...
                    <div class="mb-2">
                        <label for="faculty" class="form-label">Name of faculty </label>
                        <input type="text" id="faculty" name="faculty" class="form-control" placeholder="Enter faculty title" />
                    </div>
        ...
        dataTable = $("#example").DataTable(
        {
            ...
            columns: [
                ...
                { data: 'description'},
                {
                    data: null,
                    render: function(data, type, row) {
                        return '<button class="btn btn-primary btn-sm edit-btn mx-2" data-id="' + data.id + '" data-description="' + data.description + '" data-faculty="' + data.faculty + '"><i class="fas fa-edit mx-1"></i>Edit</button>' +
                        '<button class="btn btn-danger btn-sm delete-btn" data-id="' + data.id + '" data-title="' + data.faculty + '"><i class="fas fa-trash mx-1"></i>Remove</button>';
                    }
                }
            ],
