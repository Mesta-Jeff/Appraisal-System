        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="px-3" id="my-form">
                    ...
                    <div class="mb-1">
                        <label for="section" class="form-label">How should the option apper...?</label>
                        <input type="text" name="option_text" id="option_text" class="form-control" placeholder="Enter option here" />
                    </div>
                </form>
            ...
            columns: [
                {
                    ...
                    render: function (data, type, row) {
                        return '<input type="checkbox" class="select-checkbox" data-id="' + data.id + '" data-title="' + data.option_text + '"/>';
                    },
                },
                {
                    data: 'option_text', class: 'w-100',
                    render: function(data, type, row) {
